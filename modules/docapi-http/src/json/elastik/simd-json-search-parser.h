...
//-------------------------------------------------------------------------//
#include "search/simd-json-match-query-parser.h"
#include "search/simd-json-term-query-parser.h"
...
//-------------------------------------------------------------------------//
  ...
  struct search_request {
    ...
    //!< Keeps a query match.
    std::optional<search::match_query> match;
    //!< Keeps a term.
    std::optional<search::term_query> term;
    //!< Keeps a list of terms.
    std::optional<search::terms_query> terms;
